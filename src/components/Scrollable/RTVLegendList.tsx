...
try {
  ...
  // Left undefined. Rendering RTVLegendList throws MISSING_LEGEND_LIST_ERROR.
}
...
export const RTVLegendList = React.memo(forwardRef(RTVLegendListInner)) as <T>(
  props: RTVLegendListProps<T>
) => ReturnType<typeof RTVLegendListInner>;
